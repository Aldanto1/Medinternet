# Запуск Medinternet_bot вместе с HTTPS-туннелем cloudflared.
...
# Лог кладём в папку проекта: путь $env:TEMP при кириллическом имени пользователя
# превращается в короткий вида C:\Users\0C18~1\... и ломает Remove-Item.
